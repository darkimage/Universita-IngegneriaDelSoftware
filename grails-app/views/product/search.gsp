<html>
    <head> 
        ...
        <g:set var="searchString" value="${(params.value != null) ? params.value : ""}"/>
        <title><g:message code="com.lucafaggion.Product.search" args="${[searchString]}"/></title>
    ...
    <body>
        ...
        <div class="d-flex justify-content-end m-2 align-items-center" id="list_options">
            <div class="p-2 flex-nowrap">
                <input type="hidden" value="${searchString}" name='value' id="value">
        ...
        <div id="search-Product" class="content scaffold-list" role="main">
            <h1><g:message code="com.lucafaggion.Product.searchresultfor" args="${[searchString]}" />
            </h1>
            ...
            <g:else>
                <div id="info_message">
                    <div class="alert alert-info" role="alert"><g:message code="com.lucafaggion.Product.emptysearch" args="${[searchString]}"/></div>
                </div>
            </g:else>
